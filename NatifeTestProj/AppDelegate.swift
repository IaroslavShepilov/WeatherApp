...
//        GMSPlacesClient.provideAPIKey("AIzaSyBNflqqpNcdzqanCxZVXBGohcugyH-cRdc") // natife proj
        GMSPlacesClient.provideAPIKey("AIzaSyCDdir1tW06-UAqbGRUw-6XbLyibtWIoYc") // 3 proj
//        GMSPlacesClient.provideAPIKey("AIzaSyDBRtTNsLAP-tLAVzPzZBRstFLhSMEwTzA") // old proj
        return true
    }
